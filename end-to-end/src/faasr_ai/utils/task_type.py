...
from faasr_ai.prompts.task_type_prompts import (
...
class TaskType(Enum):
    ...
    TRANSFORM_ONLY = TaskTypeDef(
        name="transform-only",
        desc=(
            "Pure data transformation tasks with no analysis or modeling involved. "
            "Examples include summing values across datasets, joining tables, "
            "filtering rows, renaming columns, or converting formats."
        ),
        guidance=TRANSFORM_ONLY_PROMPT,
    )
