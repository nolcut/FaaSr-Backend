...
# Prompt for taking on "transform-only" tasks
TRANSFORM_ONLY_PROMPT = """
This task is a pure data transformation task.

Rules:
- Do NOT perform exploratory analysis or draw conclusions
- Do NOT train or evaluate models
- Only apply deterministic transformations to the input data
- Examples: filtering rows, joining datasets, aggregating values, renaming columns, format conversion
- Output should strictly follow the requested format
"""
